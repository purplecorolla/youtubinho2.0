    ...
    try {
      if (args[0]) {
        ...
        let FIRSTEMBED = new MessageEmbed()
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter("Page Home\n" + client.user.username + " | Dayyan OP ", client.user.displayAvatarURL())
...
📶 **\`${Math.floor(client.ws.ping)}ms\` Ping**`)
      ...
      function allotherembeds() {
        ...
        var embed5 = new MessageEmbed()
          ...
          .addField(`> **[TG WORLD](https://discord.gg/wgSH9NSQrH)**\n>`)
          .addField(`**__Bot Creator Information__**`, `>>> 💯 This Bot has been made by Tomato#6966 & Dayyan#8345:\n[Discord](https://discord.gg/wgSH9NSQrH)`)
          .setFooter(`Page 6 / 6  \nTo see command Descriptions and Information, type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL());
        embeds.push(embed5)
        return embeds
      }
